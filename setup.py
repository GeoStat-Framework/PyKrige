...
setup(name='PyKrige',
      ...
      two-dimensional ordinary and universal kriging as well as three-dimensional \
      ordinary kriging. Regional-linear, point-logarithmic, and external-scalar \
      drift terms are currently supported.',
      packages=['pykrige'],
